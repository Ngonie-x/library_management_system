...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(896, 524)
        self.layoutWidget = QtWidgets.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(9, 13, 871, 501))
        ...
        self.yes = QtWidgets.QRadioButton(self.layoutWidget_2)
        self.yes.setObjectName("yes")
        self.horizontalLayout.addWidget(self.yes)
        self.no = QtWidgets.QRadioButton(self.layoutWidget_2)
